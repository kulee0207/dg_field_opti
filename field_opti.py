...
def compute_coverage_with_horizontal(H_s, H_r, D, beamwidth_v_deg, beamwidth_h_deg, show_plot=True):
    ...
    # tilt_range = np.array(tilt_range)
    ...
    if show_plot:
        ...
        plt.axhline(best_data["max_coverage"], color='blue', linestyle='--', label=f"Max Verticla_Coverage = {best_data['max_coverage']:.2f}°")
